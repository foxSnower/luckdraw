...
function run() {
    ...
    if (!open) {
        ...
        for (var i = 0; i < mLength; i++){
            ...
            var notHave = oldItems.every(function (item) {
        ...
        for (var i = 0; i < rollNums; i++) { 
            var chosenGuy = newMembers[originalArray[i] - 1];
            while (isMemberGuyRolled(chosenGuy) != -1) {
                console.log(111)
                console.log(i, originalArray[i] - 1, originalArray)
                i++;
                chosenGuy =  newMembers[originalArray[i] - 1];;
            }
